...
import (
	...
	"github.com/0xPolygonHermez/zkevm-sequence-sender/l1infotree"
...
func NewState(cfg Config, storage storage, executorClient executor.ExecutorServiceClient, stateTree *merkletree.StateTree, mt *l1infotree.L1InfoTree) *State {
	state := &State{
		cfg:                     cfg,
		storage:                 storage,
